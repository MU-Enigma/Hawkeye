...
class random(commands.Cog):
	...
	@commands.command(help = "Sends message anonymously   | sudo echo \"Your message\" ")
	...
	@commands.command(pass_context = True ,help = "Purge messages   | sudo purge NumberOfMessagesToBeDeleted", aliases = ("clear", "cls"))
	@has_permissions(administrator=True)
	...
	@commands.command(pass_context = True ,help = "Purge messages of specific user   | sudo purge_user @mention NumberOfMessagesToBeDeleted", aliases = ("clear_user", "cls_user"))
	@has_permissions(administrator=True)
